...
export default function StatsOverview() {
  ...
  return (
    <section className="mb-20">
      ...
      <Card className="p-10 rounded-3xl shadow-subtle hover:shadow-prominent border border-border bg-card transition-apple hover-lift" data-testid="card-total-bips">
      ...
      <Card className="p-10 rounded-3xl shadow-subtle hover:shadow-prominent border border-border bg-card transition-apple hover-lift" data-testid="card-final-bips">
        <CardContent className="p-0 text-center">
      ...
      <Card className="p-10 rounded-3xl shadow-subtle hover:shadow-prominent border border-border bg-card transition-apple hover-lift" data-testid="card-active-bips">
        <CardContent className="p-0 text-center">
      ...
      <Card className="p-10 rounded-3xl shadow-subtle hover:shadow-prominent border border-border bg-card transition-apple hover-lift" data-testid="card-contributors">
        <CardContent className="p-0 text-center">
