...
export const useSEO = (seoData: SEOData) => {
  useEffect(() => {
    ...
    const ogImage = seoData.ogImage || 'https://raw.githubusercontent.com/fernikolic/bip-explorer/main/client/public/BIP_Explorer_Social_1200x630.png';
    const twitterImage = seoData.twitterCard === 'summary' ? 'https://raw.githubusercontent.com/fernikolic/bip-explorer/main/client/public/BIP_Explorer_Social_400x400.png' : 'https://raw.githubusercontent.com/fernikolic/bip-explorer/main/client/public/BIP_Explorer_Social_1024x512.png';
